...
gene <Integer,String,Double> g1 =new gene <Integer,String,Double>(val1,val2,val3);
gene <Integer,String,Double> g2 =new gene <Integer,String,Double>(val4,val5,val6);
g1.display();
g2.display();
}
}
